...
ii <- data.frame(matrix(aperm(iris3, c(1,3,2)), ncol = 4,
                        ...
                        #and W. with Width, while the rows have are unnamed 
...
hist(matrix_mini[,4],col="grey", main ="Histogram of Sum of Three Geometric Dist. Sample",xlim = c(0,1000))
...
qqline(y,
       ...
       probs = c(0.05, 0.95), col=2)
```
The extreme quantiles are very far from the Normal quatiles line and also from the central sample quantiles, in fact the sample variance is very high.
